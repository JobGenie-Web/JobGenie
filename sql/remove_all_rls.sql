...
ALTER TABLE job_invitations DISABLE ROW LEVEL SECURITY;
ALTER TABLE industries DISABLE ROW LEVEL SECURITY;
ALTER TABLE seniority_levels DISABLE ROW LEVEL SECURITY;
ALTER TABLE job_designations DISABLE ROW LEVEL SECURITY;
